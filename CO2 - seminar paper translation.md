...
This reaction is a very significant source of hydrogen ions and therefore greatly affects blood pH level. If for some reason the respiratory system is not working correctly, carbon dioxide can accumulate in blood which results in acidosis. (Mohammad Abolhassani et al. 2008)
